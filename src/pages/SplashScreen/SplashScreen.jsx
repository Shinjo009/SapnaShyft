...
/*
 * ---------------------------------------------------------------------------
 * ORIGINAL SPLASH SCREEN (Splash 1) — commented out; active route uses SplashScreen2.
 * ---------------------------------------------------------------------------
 *
 ...
 *   return (
 *     <div
 *       className="max-w-md mx-auto h-full min-h-full px-8 pt-[75px] pb-6 flex flex-col overflow-hidden"
 ...
 *       </div>
 *
 *       <div className="mt-auto flex flex-col gap-[45px]">
