...
/** B2B camp prep steps — same deck UI, camp checklist copy. */
const PREP_STEPS_B2B = [
  {
    step: 'STEP 01',
    title: 'Carry your company ID card',
...
const SlotDateCalendarIcon = ({ stroke = '#90DF9E' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    <path d="M6.66699 1.66602V4.99935M13.3337 1.66602V4.99935" stroke={stroke} strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M4.16667 3.33398H15.8333C16.7538 3.33398 17.5 4.08018 17.5 5.00065V16.6673C17.5 17.5878 16.7538 18.334 15.8333 18.334H4.16667C3.24619 18.334 2.5 17.5878 2.5 16.6673V5.00065C2.5 4.08018 3.24619 3.33398 4.16667 3.33398V3.33398" stroke={stroke} strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
...
const HouseTrackIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none" aria-hidden="true">
    <path
      d="M7 1.4L12.4 6.2V12.9C12.4 13.4 12 13.8 11.5 13.8H2.5C2 13.8 1.6 13.4 1.6 12.9V6.2L7 1.4Z"
      fill="white"
    />
    <path
...
/** Green gradient “What happens next?” card (Screen 3 redesign). */
...
const ANALYZING_TIMELINE = [
  { id: 'sample-collected', labelLines: ['Sample', 'Collected'], state: 'done' },
  { id: 'questionnaire-completed', labelLines: ['Questionnaire', 'Completed'], state: 'done' },
...
/** Monitor / progress icon for Status Timeline header. */
...
/** Horizontal gold Status Timeline card (Screen 3 redesign). */
const StatusTimelineCard = ({ steps = ANALYZING_TIMELINE }) => (
    ...
    <div className="status-timeline-card__body">
      <div className="status-timeline-card__steps">
        ...
        {steps.map((item) => (
          <div
            key={item.id}
            className={`status-timeline-card__step status-timeline-card__step--${item.state}`}
          >
            <div className="status-timeline-card__pin" aria-hidden="true">
              {item.state !== 'pending' ? (
                <>
                  <span className="status-timeline-card__marker">
                    {item.state === 'done' ? <TimelineCheckIcon /> : null}
                  </span>
...
const PrepIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
    <g clipPath="url(#clip0_scheduled_preview_prep)">
    ...
    <defs>
      <clipPath id="clip0_scheduled_preview_prep">
...
/** Clock + utensils icon for fasting step (matches reference). */
...
const HomeCollectionCard = () => (
  <section className="home-collection-card" aria-label="Home Collection">
    <h3 className="home-collection-card__title">Home Collection</h3>

    <div className="home-collection-card__rows">
      <div className="home-collection-card__row">
        <div className="home-collection-card__icon-box" aria-hidden="true">
          <TimeRowIcon fill="#90DF9E" />
        </div>
        <div className="home-collection-card__row-copy">
          <p className="home-collection-card__row-title">Sept 20, 2026  |  9:00 - 10:00 AM</p>
          <p className="home-collection-card__row-sub">Collection Window</p>
        </div>
      </div>

      <div className="home-collection-card__row">
        <div className="home-collection-card__icon-box" aria-hidden="true">
          <LocationRowIcon fill="#90DF9E" />
        </div>
        <div className="home-collection-card__row-copy">
          <p className="home-collection-card__row-title">123 Marol Naka</p>
          <p className="home-collection-card__row-sub">Mumbai, Maharashtra</p>
        </div>
      </div>
    </div>
    ...
    <div className="home-collection-card__status">
      ...
      <div className="home-collection-card__status-row">
        ...
        <p className="home-collection-card__status-text">Your Health Companion is on the way</p>
      </div>
    </div>
  </section>
);

/** Same card shell as Home Collection; B2B assigned-slot content. */
const AssignedSlotCard = () => (
  <section className="home-collection-card" aria-label="Your Assigned Slot">
    <div className="home-collection-card__head">
      <h3 className="home-collection-card__title">Your Assigned Slot</h3>
      <span className="home-collection-card__arrive-pill">Arrive 10 mins early</span>
    </div>
    ...
    <div className="home-collection-card__rows">
      <div className="home-collection-card__row">
        ...
        <div className="home-collection-card__row-copy">
          <p className="home-collection-card__row-title">09:00 AM – 11:00 AM</p>
          <p className="home-collection-card__row-sub">Testing Window</p>
        </div>
      </div>
      ...
      <div className="home-collection-card__row">
        ...
        <div className="home-collection-card__row-copy">
          <p className="home-collection-card__row-title">Friday, 31 Jul</p>
          <p className="home-collection-card__row-sub">Engagement Date</p>
        </div>
      </div>
      ...
      <div className="home-collection-card__row">
        ...
        <div className="home-collection-card__row-copy">
          <p className="home-collection-card__row-title">Lotus Skygarden, Malad West</p>
          <p className="home-collection-card__row-sub">Mumbai Coastal Road, Mumbai 400064</p>
        </div>
      </div>
    </div>
  </section>
 ...
 */
const PrepStepsDeck = ({ steps = PREP_STEPS_B2C }) => {
  ...
  const getCardStyle = (index) => {
    ...
    // Hide cards far behind or far ahead
    ...
    // Cards stacked behind — peek from top-right like the reference
  ...
  return (
    ...
    >
      ...
      <div className="home-page-scheduled__card home-page-scheduled__card--home-collection-wrap">
        {isCamp ? <AssignedSlotCard /> : <HomeCollectionCard />}
      </div>
