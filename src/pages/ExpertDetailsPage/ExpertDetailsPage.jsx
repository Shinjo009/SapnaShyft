...
const formatSelectedAppointment = (selectedDateId, selectedTimeSlot) => {
  ...
  return `${selectedDate.date}th ${selectedDate.month}  |  ${prettyTime}`;
};
...
const EXPERT_DATA = {
  doctor: {
    ...
    about: 'Dr. Sarah Jenkin is a world-renowned specialist in preventative Physics and General. With a patient-first philosophy, he integrates advanced diagnostic tech with personalized lifestyle strategies.',
    consultation: [
...
const ExpertDetailsPage = ({ onBack, expertType = 'doctor' }) => {
  ...
  const reviewDateText = useMemo(() => {
    ...
    return `${selectedDate.month} ${selectedDate.date}, ${selectedDate.fullDay}`;
  }, [selectedDateId]);
            ...
            {scheduleStep === 'schedule' ? (
              <>
                ...
                <div className="expert-details-page__schedule-time-head">
                  ...
                  <p className="expert-details-page__schedule-time-subtitle">Choose appointment start time</p>
                </div>
              ...
              <div className="expert-details-page__review-flow">
                ...
                <section className="expert-details-page__review-doctor-card" aria-label="Doctor summary">
                  <div className="expert-details-page__review-doctor-row">
                    ...
                    <div className="expert-details-page__review-doctor-copy">
                      ...
                      <p className="expert-details-page__review-doctor-role">Senior Neuro-specialist</p>
                      <div className="expert-details-page__review-rating-row">
                        <ReviewStarIconTiny />
                        <span className="expert-details-page__review-rating-value">4.9</span>
                        <span className="expert-details-page__review-rating-count">(1.2k reviews)</span>
                      </div>
                    </div>
                  </div>
                ...
                <section className="expert-details-page__review-payment-card" aria-label="Payment summary card">
                  <div className="expert-details-page__review-payment-row">
                    ...
                    <span className="expert-details-page__review-payment-value">Rs. 320/-</span>
                  </div>
                  <div className="expert-details-page__review-payment-row">
                    <span className="expert-details-page__review-payment-label">Service Tax (5%)</span>
                    <span className="expert-details-page__review-payment-value">Rs. 6.50/-</span>
                  </div>
                  ...
                  <div className="expert-details-page__review-payment-total">
                    ...
                    <div className="expert-details-page__review-payment-total-right">
                      <span className="expert-details-page__review-payment-total-value">Rs 326.50/-</span>
              ...
              <div className="expert-details-page__confirmed-flow">
                ...
                <p className="expert-details-page__confirmed-text">The doctor will notify you when they&rsquo;re available within your selected time.</p>
                ...
                <section className="expert-details-page__confirmed-doctor" aria-label="Confirmed doctor">
                  ...
                  <div className="expert-details-page__confirmed-doctor-copy">
                    ...
                    <p className="expert-details-page__confirmed-doctor-role">General Physician</p>
                  </div>
                </section>
