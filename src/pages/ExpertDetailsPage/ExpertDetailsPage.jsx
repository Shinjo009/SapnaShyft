...
import supercareBackground from '../../images/Supercare_BG.svg';
...
const SessionSparkleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
    <g clipPath="url(#clip0_5169_6512)">
      <path d="M6.4266 1.64127C6.47816 1.36518 6.71915 1.16504 7.00001 1.16504C7.28087 1.16504 7.52186 1.36518 7.57343 1.64127L8.18651 4.88344C8.27563 5.35517 8.64461 5.72416 9.11635 5.81327L12.3585 6.42635C12.6346 6.47792 12.8347 6.71891 12.8347 6.99977C12.8347 7.28063 12.6346 7.52162 12.3585 7.57319L9.11635 8.18627C8.64461 8.27538 8.27563 8.64437 8.18651 9.1161L7.57343 12.3583C7.52186 12.6344 7.28087 12.8345 7.00001 12.8345C6.71915 12.8345 6.47816 12.6344 6.4266 12.3583L5.81351 9.1161C5.7244 8.64437 5.35541 8.27538 4.88368 8.18627L1.64151 7.57319C1.36543 7.52162 1.16528 7.28063 1.16528 6.99977C1.16528 6.71891 1.36543 6.47792 1.64151 6.42635L4.88368 5.81327C5.35541 5.72416 5.7244 5.35517 5.81351 4.88344L6.4266 1.64127M11.6667 1.16644V3.49977M12.8333 2.3331H10.5" stroke="#7A9BCA" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M1.16669 11.6667C1.16669 12.3106 1.68945 12.8333 2.33335 12.8333C2.97725 12.8333 3.50002 12.3106 3.50002 11.6667C3.50002 11.0228 2.97725 10.5 2.33335 10.5C1.68945 10.5 1.16669 11.0228 1.16669 11.6667H1.16669" stroke="#7A9BCA" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
    </g>
    <defs>
      <clipPath id="clip0_5169_6512">
...
const PLAN_STATS = [
  { label: 'Experts', value: 'Clinical' },
  { label: 'Session', value: '30 Mins' },
  { label: 'Guidance', value: 'Personal' },
];

const EXPERT_DATA = {
  doctor: {
    planTitle: 'Priority Doctor Connect',
    sessionLabel: 'Focused Health Guidance Session',
    heroImage: priorityDoctorImage,
    role: 'Doctor',
    ...
    footerFeeOff: '44% OFF',
    stats: PLAN_STATS,
    consultationCovers: ['Health Assessment', 'Symptom Review', 'Lifestyle Support', 'Medical Queries'],
    about:
      'Dr. Sarah Jenkins is a specialist in preventive and general medicine. With a patient-first approach, she combines diagnostic insights with practical lifestyle guidance for long-term health.',
    consultation: [
  ...
  nutritionist: {
    planTitle: 'Holistic Nutrition Consult',
    sessionLabel: 'Focused Wellness Guidance Session',
    heroImage: holisticNutritionImage,
    role: 'Nutritionist',
    ...
    footerFeeOff: '44% OFF',
    stats: PLAN_STATS,
    consultationCovers: ['Meal Guidance', 'Eating Habits', 'Lifestyle Support', 'Nutrition Queries'],
    about:
      'Dr. Anaya Mehta is a specialist in clinical nutrition with a prevention-first approach. She creates practical, personalized plans built around your labs, lifestyle, and long-term goals.',
    consultation: [
      { id: 'video', icon: <ConsultationVideoIcon />, label: 'Video / Chat' },
      { id: 'language', icon: <ConsultationLanguageIcon />, label: 'English, Hindi, Tamil, Telugu, Malayalam' },
...
const ExpertDetailsPage = ({ onBack, expertType = 'doctor' }) => {
  ...
  return (
    <div
      className="expert-details-page"
      style={{ '--supercare-page-bg': `url("${supercareBackground}")` }}
    >
      <section className="expert-details-page__hero" aria-label={planTitle}>
        <div className="expert-details-page__hero-media" aria-hidden="true">
          <img className="expert-details-page__hero-image" src={data.heroImage} alt="" />
          <div className="expert-details-page__hero-gradient" />
        </div>

        <button type="button" className="expert-details-page__hero-back" onClick={onBack} aria-label="Go back">
          <BackIcon />
        </button>

        <div className="expert-details-page__hero-bottom">
          <div className="expert-details-page__session-badge">
            <SessionSparkleIcon />
            <span>{data.sessionLabel}</span>
          </div>
          <h1 className="expert-details-page__plan-title">{planTitle}</h1>
        </div>
      </section>
      ...
      <section className="expert-details-page__consultation-covers" aria-label="Consultation covers">
        <h3 className="expert-details-page__section-title">Consultation Covers</h3>
        <div className="expert-details-page__pills">
          {data.consultationCovers.map((item) => (
              ...
              <div className="expert-details-page__review-flow">
                ...
                <section className="expert-details-page__review-doctor-card" aria-label="Expert summary">
                  <div className="expert-details-page__review-doctor-row">
                    <img src={data.heroImage} alt={planTitle} className="expert-details-page__review-doctor-photo" />

                    <div className="expert-details-page__review-doctor-copy">
                      <h4 className="expert-details-page__review-doctor-name">{planTitle}</h4>
              ...
              <div className="expert-details-page__confirmed-flow">
                ...
                <section className="expert-details-page__confirmed-doctor" aria-label="Confirmed doctor">
                  <div className="expert-details-page__confirmed-doctor-photo-wrap">
                    <img src={data.heroImage} alt={planTitle} className="expert-details-page__confirmed-doctor-photo" />
                  </div>

                  <div className="expert-details-page__confirmed-doctor-copy">
                    <h4 className="expert-details-page__confirmed-doctor-name">{planTitle}</h4>
