...
/**
 * Dedicated cube for SplashScreen3.
 * Keep changes here isolated from SplashScreen4's `RotatingCube`.
 */
export default function RotatingCube3({ variant = 'icons', showLabelIcons = true }) {
